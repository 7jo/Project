							...
							<li class="left clearfix"><span class="chat-img pull-left">
								...
								<div class="chat-body clearfix">
									...
									<div class="panel-footer">
										<table>
											<tr>
												<td><strong class="primary-font">작성자&nbsp</strong></td>
												<td><strong class="primary-font"><%=id%></strong></td>
											</tr>
										</table>
										<br />
										<div class="input-group">
											<input id="comment" type="text" class="form-control input-sm"
												...
												<button class="btn btn-warning btn-sm" id="btn-chat"
													onclick="javascript:submit();">Send</button>
											</span>
										</div>
									</div>
						...
						<div class="row">
							...
							<div class="col-footer col-md-4 col-xs-6">
								...
								<p class="contact-us-details">
									<b>Address:</b> 123 Fake Street, LN1 2ST, London, United
									Kingdom<br /> <b>Phone:</b> +44 123 654321<br /> <b>Fax:</b>
									+44 123 654321<br /> <b>Email:</b> <a
