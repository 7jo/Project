							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="list-group">
										...
										<a href="${pageContext.request.contextPath}/detail?place=a"
											class="list-group-item"> <i class="fa fa-comment fa-fw"></i>
											&nbsp;&nbsp;&nbsp;<img src="img/bt.png">&nbsp;관광지 A <span
											class="pull-right text-muted small"><em>detail>></em>
										</span>
										</a> <a href="${pageContext.request.contextPath}/detail?place=b"
											class="list-group-item"> <i class="fa fa-comment fa-fw"></i>
											&nbsp;&nbsp;&nbsp;<img src="img/bt.png">&nbsp;관광지 B <span
											class="pull-right text-muted small"><em>detail>></em>
										</span>
										</a>

										<div id="recmdlist"></div>
									</div>
