...
<body>
   ...
   <h2 align="center">회원 가입 <b>완료</h2>
   
   <table  border="1" width="600" height="300">
   <tr>
   <td> <img src="${pageContext.request.contextPath}/img/oksign.png">
   </td>
   <td align="center" width="300">
   <h3 style="font:bold;">축하합니다.<br>
   회원가입이 완료되었습니다.</h3>
   <br>
   <br><br><br><br>
   <a href="/Tour/page-login.jsp?islogin=true"><button type="button">로그인 페이지</button></a>

   <a href="/Tour/index.jsp"><button type="button">메인 페이지</button></a>
   </td>
   </tr>
   </table>
</div>   
