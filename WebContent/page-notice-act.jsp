...
<body>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea class="form-control" name="contents" cols="12" rows="12" form="noticeform"><%=contents %></textarea>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<form action="/Tour/notice" id="noticeform" method="POST">
		<input type=hidden name="act" value="<%=act %>">
		<input type=hidden name="id" value="<%=id %>">
		<div class="pull-right">
			<input type="submit" class="btn btn-default" value="<%=button_text%>">&nbsp;&nbsp; 
			<a href="/Tour/notice">
