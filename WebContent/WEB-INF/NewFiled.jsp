                            ...
                            <ul class="chat">
                                <li class="left clearfix">
                                    ...
                                    <div class="chat-body clearfix">
                                        <div class="header">
                                            <strong class="primary-font"id="userid"><%=id%></strong>
                  ...
                  <tr id="comment_table"></tr>
                        ...
                        <div class="panel-footer">
                            <div class="input-group">
                                <input id="btn-input" type="text"id="comment" class="form-control input-sm" placeholder="Type your message here..." />
                                <span class="input-group-btn">
                                    <button class="btn btn-warning btn-sm" id="btn-chat"    onclick="javascript:submit();">
                                        Send
                                    </button>
                                </span>
                            </div>
